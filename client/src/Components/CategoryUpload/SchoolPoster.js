...
function SchoolPoster(props) {
    ...
    return (
        <div>
            ...
            <input type='text' ref={NewSchoolRef} /> <br />
            <input type='submit' value='Add' onClick={event => props.SubmitSchool(event, SubjectsRef.current, NewSchoolRef.current.value)}/>
        </div>
    )
}

export default SchoolPoster;